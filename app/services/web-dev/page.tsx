  ...
  return (
    <div className="text-primary-content grid grid-cols-1 grid-rows-4 min-h-screen">
      <div className="">
        ...
        <p>
          Need a complex website, let&apos;s get to talking and figuring out
          what&apos;s best for you in terms of hosting, what you actually need
          from your website and how web development can help you achieve that.
        </p>
        <p>
